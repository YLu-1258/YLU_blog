...
- header: Contains information as to the name and type of the algorithm that is used for encryption.
- payload: Contains the actual data that is being encrypted and secured
- signature: Used for verification that the JWT was sent by the proper person
- algorithm: The algorithm used to encrypt the payload
- secret key: The secret key used to obfuscate the secret.
